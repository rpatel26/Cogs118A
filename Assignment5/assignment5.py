...
def linearTrain( X, Y, testX, testY ):
	...
	mat = np.linspace( 0.1, 10, num = 500 )
	for i in mat:
...
''' 20% Testing Set '''
X1train, X1test, Y1train, Y1test = splitData( X1, Y1, 0.2 )
linearTrain( X1train, Y1train, X1test, Y1test )
rbfTrain( X1train, Y1train, X1test, Y1test )
print "\n"

''' 40% Testing Set '''
X1train, X1test, Y1train, Y1test = splitData( X1, Y1, 0.4 )
linearTrain( X1train, Y1train, X1test, Y1test )
rbfTrain( X1train, Y1train, X1test, Y1test )
print "\n"

''' 60% Testing Set '''
X1train, X1test, Y1train, Y1test = splitData( X1, Y1, 0.6 )
linearTrain( X1train, Y1train, X1test, Y1test )
rbfTrain( X1train, Y1train, X1test, Y1test )
print "End Problem 1"
print "\n"
...
X2 = fixNan( X2 )
Y2 = convertLabels( Y2, 'setosa' )

''' 20% Testing Set '''
X2train, X2test, Y2train, Y2test = splitData( X2, Y2, 0.2 )
linearTrain( X2train, Y2train, X2test, Y2test )
rbfTrain( X2train, Y2train, X2test, Y2test )
print "\n"

''' 40% Testing Set '''
X2train, X2test, Y2train, Y2test = splitData( X2, Y2, 0.4 )
linearTrain( X2train, Y2train, X2test, Y2test )
rbfTrain( X2train, Y2train, X2test, Y2test )
print "\n"

''' 60% Testing Set '''
X2train, X2test, Y2train, Y2test = splitData( X2, Y2, 0.6 )
linearTrain( X2train, Y2train, X2test, Y2test )
rbfTrain( X2train, Y2train, X2test, Y2test )
print "End Problem 2"
print "\n"
